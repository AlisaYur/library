                ...
                <div class="operations-list">
                    ...
                    <button class="btn waves-effect waves-light btn_log_out"
                        ...
                        <a class="log_out_link"
                           href="${pageContext.request.contextPath}/mainMenu?action=HistoryManagerOrders">
                            <span class="log_out_span">History Orders</span><i
                                class="material-icons log_out_icon">history</i>
                        </a>
                    </button>
