(function ($, anim) {
  ...
  class Dropdown extends Component {
    constructor(el, options) {
      ...
      this._handleDocumentTouchmoveBound = this._handleDocumentTouchmove.bind(
          this);
    ...
    _handleMouseLeave(e) {
      ...
      let leaveToDropdownContent = !!$(toEl).closest(
    ...
    _handleDropdownKeydown(e) {
      ...
      } else if ((e.which === M.keys.ARROW_DOWN || e.which === M.keys.ARROW_UP)
          && this.isOpen) {
        e.preventDefault();
    ...
    _getDropdownPosition() {
      ...
      if (!alignments[horizontalAlignment]) {
        let oppositeAlignment = horizontalAlignment === 'left' ? 'right'
            : 'left';
      ...
      if (verticalAlignment === 'bottom') {
        idealYPos =
            idealYPos - dropdownBRect.height + (this.options.coverTrigger
            ? triggerBRect.height : 0);
      }
