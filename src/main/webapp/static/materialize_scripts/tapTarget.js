(function ($) {
  ...
  class TapTarget extends Component {
    ...
    _calculatePositioning() {
      ...
      let isCenterX = originLeft >= windowWidth * 0.25 && originLeft
          <= windowWidth * 0.75;
      ...
      // Calculating content
      let tapTargetTextWidth = isCenterX ? tapTargetWidth : tapTargetWidth / 2
          + originWidth;
      let tapTargetTextHeight = tapTargetHeight / 2;
      let tapTargetTextTop = isTop ? tapTargetHeight / 2 : 0;
      let tapTargetTextBottom = 0;
      let tapTargetTextLeft = isLeft && !isCenterX ? tapTargetWidth / 2
          - originWidth : 0;
      ...
      // Calculating wave
      let tapTargetWaveWidth = originWidth > originHeight ? originWidth * 2
          : originWidth * 2;
